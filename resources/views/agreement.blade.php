            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-7">
                    <div class="single-blog-content mb-100">
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <h4>Agreements With Our Customers</h4>
                        </div>
                        <!-- Post Content -->
              ...
              <p>
                By being connected to water supply system Managed by <strong>Ayateke Star Co.Ltd</strong> you agreed that all the equipments and applience are becoming ayateke star equipments, any additional or repair and others related must be informed and accepted by <strong>Ayateke Star.Co.Ltd!</strong>
              </p>
                            <blockquote class="mb-30">
                             We are Allowed to visit our water meters anywhere and anytime we want, To make sure usage and control of our supplied water 
                            </blockquote>                            
                            <h6> 
              </a>
              <p>
              We will be providing the billing receipt with in the end of every month, the payment is made next 15days after receiving the bill through our Bank accounts <br>
              check out our<a href="{{url('/information')}}"> Banks Account</a> for Payments<a href="{{url('/information')}}"> here</a>
              </p></h6>
              <blockquote class="mb-30">
               We are Allowed to visit our water meters anywhere and anytime we want, To make sure usage and control of our supplied water 
              </blockquote> 
